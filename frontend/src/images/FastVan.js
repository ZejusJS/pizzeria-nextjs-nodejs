...
export default function FastVan() {
	return (
		<svg className='delivery-van' height="800px" id="Icons" width="800px" version="1.1" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve">
			<g>
